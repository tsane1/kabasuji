 ...
 *
 */
public class TestBackController extends TestCase {
	SuperModel sm;
	Screen pls, lls, rls;
	Application app;
	Level pl, ll, rl;
...
//		lpv.installControllers();
		...
		BackController plc = new BackController(app, sm);
		
//		lpv.getBackBtn().addActionListener(new BackController(app, sm));
//		lpv.getBackBtn().doClick();
