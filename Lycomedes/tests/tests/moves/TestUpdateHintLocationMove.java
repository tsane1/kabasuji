...
/**
 * Test cases involving updating hint locations.
...
public class TestUpdateHintLocationMove extends TestCase {
	SuperModel sm;
	Level pl, ll, rl;
	int row = 0;
	int col = 0;
	...
	public void testBullpenToBoardPL(){
		...
		Move plm = new UpdateHintLocationMove(row, col, pl);
	...
	public void testBullpenToBoardLL(){
		...
		/** Activate tile in row 0 col 0 piece in Board on row 1 col 1. */
		Move llm = new UpdateHintLocationMove(row, col, ll);
	...
	public void testBullpenToBoardRL(){
		...
		/** Activate tile in row 0 col 0 piece in Board on row 1 col 1. */
		Move rlm = new UpdateHintLocationMove(row, col, rl);
