...
/**
 * Test cases flipping a piece over the X axis.
...
public class TestFlipXMove extends TestCase {
	SuperModel sm;
	Level pl, ll, rl;
	int row = 0;
	int col = 0;
