...
/**
 * Test cases rotating a piece left.
...
public class TestRotateRightMove extends TestCase {
	SuperModel sm;
	Level pl, ll, rl;
	int row = 0;
	int col = 0;
	...
	public void testBullpenToBoardPL(){
		...
		Move plm = new RotateLeftMove(pl);
	...
	public void testBullpenToBoardLL(){
		...
		/** Activate tile in row 0 col 0 piece in Board on row 1 col 1. */
		Move llm = new RotateLeftMove(ll);
	...
	public void testBullpenToBoardRL(){
		...
		/** Activate tile in row 0 col 0 piece in Board on row 1 col 1. */
		Move rlm = new RotateLeftMove(rl);
