...
/**
 * Test cases rotating a piece right.
...
public class TestRotateLeftMove extends TestCase {
	SuperModel sm;
	Level pl, ll, rl;
	int row = 0;
	int col = 0;
	...
	public void testBullpenToBoardPL(){
		...
		Move plm = new RotateRightMove(pl);
	...
	public void testBullpenToBoardLL(){
		...
		/** Activate tile in row 0 col 0 piece in Board on row 1 col 1. */
		Move llm = new RotateRightMove(ll);
	...
	public void testBullpenToBoardRL(){
		...
		/** Activate tile in row 0 col 0 piece in Board on row 1 col 1. */
		Move rlm = new RotateRightMove(rl);
