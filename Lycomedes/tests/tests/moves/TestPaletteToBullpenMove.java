...
/**
 * Test cases moving a piece from the Palette to the Bullpen.
...
public class TestPaletteToBullpenMove extends TestCase {
	SuperModel sm;
	Level pl, ll, rl;
	int row = 0;
	int col = 0;
	...
	public void testBullpenToBoardPL(){
		...
		Move plm = new PaletteToBullpenMove(pl, testPiece);
	...
	public void testBullpenToBoardLL(){
		...
		/** Activate tile in row 0 col 0 piece in Board on row 1 col 1. */
		Move llm = new PaletteToBullpenMove(ll, testPiece);
	...
	public void testBullpenToBoardRL(){
		...
		/** Activate tile in row 0 col 0 piece in Board on row 1 col 1. */
		Move rlm = new PaletteToBullpenMove(rl, testPiece);
