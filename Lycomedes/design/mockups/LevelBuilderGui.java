...
public class LevelBuilderGui extends JFrame {
	...
	public LevelBuilderGui() {
		...
		label.setIcon(new ImageIcon(this.getClass().getResource("/design/12x12gridedit.jpg")));
		
		JTabbedPane LevelAttributeTabbedPane = new JTabbedPane(JTabbedPane.TOP);
		
		JLabel lblNewLabel_7 = new JLabel("");
		lblNewLabel_7.setIcon(new ImageIcon(this.getClass().getResource("/design/12x12gridedit.jpg")));
