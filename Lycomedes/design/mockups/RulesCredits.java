...
public class RulesCredits extends JFrame {
	...
	private void initWindow() {
		...
		JLabel lblKabasuji = new JLabel("Rules");
	...
	private void populate() {
		...
		tabbedPane.setFont(new Font("Kristen ITC", Font.PLAIN, 18));
		contentPane.add(tabbedPane);
		
		JTextArea txtrPuzzleMode = new JTextArea();
		txtrPuzzleMode.setForeground(new Color(255, 0, 0));
		...
		txtrLightningMode.setForeground(new Color(255, 215, 0));
		...
		txtrReleaseModeIn.setForeground(new Color(50, 205, 50));
